...
class Blog:
    def __init__(self):
        self.__Tablename__ = "Everest_Blog"
...
if __name__ == "__main__":
    ...
    # for update post
    # res = blog.update_blog(BlogName="BlogService", New_BlogDate='OCT 09, 2020', New_BlogTime='5 PM', New_BlogContent='update workingV1',  New_BlogLocation="NY")
